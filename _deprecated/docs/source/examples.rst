...
.. code-block:: python
   :linenos:
    ...
    from carla import OnlineCatalog, ModelCatalog
    ...
    # 2. Load pre-trained black-box model from the ModelCatalog
    model = ModelCatalog(dataset, "ann")
...
.. code-block:: python
   ...
   from data.catalog import CsvCatalog
